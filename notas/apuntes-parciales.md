...
* el bucle for in recorre objetos ya que los objetos a diferencia de los arreglos no contiene indices
* en los apuntes Henry 05- IV se itera con for in para hacer impreciones de pantalla de cada objeto


## ¿que más se puede hacer

* key in objeto retorna true si está, y false si no
* el bucle for recorre todo el objeto
	* no hay error de bucle infinito
...
* for in
	* for (var prop in obj){
		// con prop se puede acceder a la key de la propiedad
		// con obj[prop] se puede acceder al value de la propiedad
	}

**nota	for sirve unicamente para recorrer array; for-in unicamente para recorrer objetos**  esto no es asi

### this
* dice que this es un objeto
...
* las class comparten muchas funcionalidades de los objetos, pero se expanden en las fucionalidades contructoras de objetos.
